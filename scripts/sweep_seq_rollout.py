...
not contaminated by a previous run's allocator pool.
    ...
    .venv/bin/python scripts/sweep_seq_rollout.py --sweep hands
    .venv/bin/python scripts/sweep_seq_rollout.py --sweep model
"""
...
REPORT = ROOT / "scripts" / "report_seq_branch_shape.py"
